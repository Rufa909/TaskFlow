      ...
      <div className="auth-left">
        <div>
          <div className="brand-logo">
            <img src="/src/images/icon.png" alt="Task Flow Logo" style={{ width: '50px', height: '50px' }} />
        ...
        <div className="feature-list">
          {[
            ...
            ['Collaborative work', 'Assign tasks and track propress in real-time'],
        ...
        <div className="left-footer">© 2026 Task Flow · All rights reserved</div>
      </div>
          ...
          {tab === 'login' && (
            <form onSubmit={handleLogin}>
              ...
              <button type="submit" className="submit-btn" disabled={loading}>
                {loading ? <><div className="spinner" /> Processing...</> : 'Login'}
              </button>
